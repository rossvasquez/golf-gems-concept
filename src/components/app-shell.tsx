...
export function AppShell() {
  ...
  useEffect(() => {
    setCourseData(
      courseData.steps,
      courseData.error ? "error" : courseData.isLoading ? "loading" : "ready",
            ...
            >
              <div className="mx-auto max-w-3xl">
                ...
                <p className="mt-5 max-w-2xl text-base leading-7 text-muted-foreground">
                  You moved through {steps.length} ranked courses from the
                  IndexedDB-backed GeoJSON cache. Next round we can add
                  authoring flows without changing the map story foundation.
                </p>
