...
export function AdminDrawMap({ geometry, onGeometryChange }: AdminDrawMapProps) {
    ...
    return (
      <div className="grid min-h-80 place-items-center border border-emerald-950/15 bg-emerald-950 p-6 text-white">
        <div className="max-w-sm">
          <AlertTriangle className="size-5 text-emerald-200" aria-hidden="true" />
  ...
  return (
    <div
      ref={containerRef}
      className="min-h-80 overflow-hidden border border-emerald-950/15 bg-emerald-950 [&_.mapboxgl-ctrl-group]:!rounded-none"
    />
  )
}
